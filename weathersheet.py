...
while True:
    ...
    try:
        ...
        #sheet.clear()
        #listtitle=["date","time","wind direction","windrate","rainfall","temperature","humidity",'atmosphere','datetime']
        ...
        while True:
            ...
            listdata=[date,hour,winddir,windrate,rain,tem,hum,atm,date1]
